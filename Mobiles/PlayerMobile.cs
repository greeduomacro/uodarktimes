...
namespace Server.Mobiles
{
	...
	public class PlayerMobile : Mobile, IHonorTarget
	{
		...
		//added
		private bool m_DidChivalryQuest;	

		private bool m_DidSwordsQuest;
		private bool m_DidTacticsQuest;
		private bool m_DidHealingQuest;
		private bool m_DidAnatomyQuest;
		private bool m_DidFocusQuest;
		private bool m_DidParryQuest;

		private bool m_DidMageryQuest;
		private bool m_DidMeditationQuest;
		private bool m_DidEvalIntQuest;
		private bool m_DidWrestlingQuest;
		private bool m_DidInscribeQuest;
		private bool m_DidMagicResistQuest;

		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidChivalryQuest
		{
			get{ return m_DidChivalryQuest; }
			set{ m_DidChivalryQuest = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidSwordsQuest
		{
			get{ return m_DidSwordsQuest; }
			set{ m_DidSwordsQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidTacticsQuest
		{
			get{ return m_DidTacticsQuest; }
			set{ m_DidTacticsQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidHealingQuest
		{
			get{ return m_DidHealingQuest; }
			set{ m_DidHealingQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidAnatomyQuest
		{
			get{ return m_DidAnatomyQuest; }
			set{ m_DidAnatomyQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidFocusQuest
		{
			get{ return m_DidFocusQuest; }
			set{ m_DidFocusQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidParryQuest
		{
			get{ return m_DidParryQuest; }
			set{ m_DidParryQuest = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidMageryQuest
		{
			get{ return m_DidMageryQuest; }
			set{ m_DidMageryQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidMeditationQuest
		{
			get{ return m_DidMeditationQuest; }
			set{ m_DidMeditationQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidEvalIntQuest
		{
			get{ return m_DidEvalIntQuest; }
			set{ m_DidEvalIntQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidWrestlingQuest
		{
			get{ return m_DidWrestlingQuest; }
			set{ m_DidWrestlingQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidInscribeQuest
		{
			get{ return m_DidInscribeQuest; }
			set{ m_DidInscribeQuest = value; }
		}
		[CommandProperty( AccessLevel.GameMaster )]
		public bool DidMagicResistQuest
		{
			get{ return m_DidMagicResistQuest; }
			set{ m_DidMagicResistQuest = value; }
		}


		private bool m_HasSixMonthsStatReward;

		[CommandProperty( AccessLevel.GameMaster )]
		public bool HasSixMonthsStatReward
		{
			get{ return m_HasSixMonthsStatReward; }
			set{ m_HasSixMonthsStatReward = value; }
		}
		...
		public override void AggressiveAction( Mobile aggressor, bool criminal )
		{
			...
			if ( Warmode && Combatant == null )
				Combatant = aggressor;
			else if ( !Warmode )
				Combatant = null;				
		}

		private bool m_HideFactionMessage;

		[CommandProperty( AccessLevel.GameMaster )]
		public bool HideFactionMessage
		{
			get{ return m_HideFactionMessage; }
			set{ m_HideFactionMessage = value; }
		}

		private bool m_AllowSpellweaving;

		[CommandProperty( AccessLevel.GameMaster )]
		public bool AllowSpellweaving
		{
			get{ return m_AllowSpellweaving; }
			set{ m_AllowSpellweaving = value; }
		}

		public int WoodRegenHitsBonus;
		public int WoodHitLifeLeechBonus;
		public int WoodHitChanceBonus;
		public int WoodDamageBonus;
		public int WoodFasterCastBonus;
...
//end
//Added by Jaynigs
		private DateTime m_GGSStattime;
		private int m_GGSStatCount;

		private bool m_GGSActive;

		[CommandProperty( AccessLevel.GameMaster )]
		public bool GGSActive
		{
			get{ return m_GGSActive; }
			set{ m_GGSActive = value; }
		}
		
		[CommandProperty( AccessLevel.GameMaster )]
		public int GGS_StatCount
		{
			get{ return m_GGSStatCount; }
			set{ m_GGSStatCount = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public DateTime GGS_Stattime
		{
			get{ return m_GGSStattime; }
			set{ m_GGSStattime = value; }
		}

		private bool m_Maulboon;
		private bool m_Strongrootboon;
		private bool m_Enigmaboon;
		private bool m_Bravehornboon;
		private bool m_Huntsmanboon;
		private bool m_Arielleboon;
		private bool m_Allboons;

		[CommandProperty( AccessLevel.GameMaster )]
		public bool MaulBoon
		{
			get{ return m_Maulboon; }
			set{ m_Maulboon = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool StrongrootBoon
		{
			get{ return m_Strongrootboon; }
			set{ m_Strongrootboon = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool EnigmaBoon
		{
			get{ return m_Enigmaboon; }
			set{ m_Enigmaboon = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool BravehornBoon
		{
			get{ return m_Bravehornboon; }
			set{ m_Bravehornboon = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool HuntsmanBoon
		{
			get{ return m_Huntsmanboon; }
			set{ m_Huntsmanboon = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool ArielleBoon
		{
			get{ return m_Arielleboon; }
			set{ m_Arielleboon = value; }
		}

		[CommandProperty( AccessLevel.GameMaster )]
		public bool AllBoons
		{
			get{ return m_Allboons; }
			set{ m_Allboons = value; }
		}
		...
		public DateTime NextDrinkConflagrationPotion
		{
			get{ return m_NextDrinkConflagrationPotion; }
			set{ m_NextDrinkConflagrationPotion = value; }
		}

		public DateTime NextDrinkConfusionPotion
		{
			get{ return m_NextDrinkConfusionPotion; }
			set{ m_NextDrinkConfusionPotion = value; }
		}

		private Map m_StartMap;
		private Point3D m_StartLoc;
		private int m_GuideMessage;

		public Map StartMap { get { return m_StartMap; } set{ m_StartMap = value; } }
		public Point3D StartLoc { get { return m_StartLoc; } set{ m_StartLoc = value; } }
		public int GuideMessage { get { return m_GuideMessage; } set{ m_GuideMessage = value; } }
...
// block faction skill loss during challenge games
		...
		public Hashtable SkillGainTimes;
