...
namespace Xanthos.Utilities
{
	public class NewsGump : Gump
	{
		...
		private const string kGreeting		= "Vitej na shardu Dark Times.";
		private const string kDefaultBody	= "V soucasne dobe nejsou zadne novinky.";
		private const string kDefaultTitle	= "Soucasne novinky.";
		private const string kNewMotdMessage= "Zprava dne byla upravena. pro zobrazeni napiste motd.";
