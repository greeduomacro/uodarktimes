...
//----------------------/----------------------------------------------/
"<BASEFONT COLOR=YELLOW>Vitej mlady dobrodruhu.  Jsem zde, abych otestoval tve bojove zkusenosti.<BR><BR>Az se budes citit pripraven k prvni zkousce, tak mi prosim predloz tvuj Letter of Apprenticeship." +
						     "</BODY>", false, true);
...
//--------------------------------------------------------------------------------------------------------------
      ...
      { 
         ...
         { 
            ...
            { 
               //Cancel 
               from.SendMessage( "Vrat se zpatky az budes pripraven na tvuj trening!" );
               break; 
            } 
