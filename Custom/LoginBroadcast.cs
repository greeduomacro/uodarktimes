...
namespace mordero.Custom
{
    class Broadcast
    {
        ...
        private readonly static string m_LoginMessage = "{0} vstoupil do tohoto sveta ";//logging in
        private readonly static string m_LogoutMessage = "{0} opustil tento svet";//logging out
