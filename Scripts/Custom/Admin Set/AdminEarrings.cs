...
{
	public class AdminEarrings : GoldEarrings
	{
        public override int ArtifactRarity{ get{ return 20; } }
	
		[Constructable]
		public AdminEarrings()
		{
			
			Weight = 0.0; 
            Name = "Admin's Earrings";
            Hue = 0x35;

        SkillBonuses.SetValues( 0, SkillName.Alchemy, 65535.5 );
		SkillBonuses.SetValues( 1, SkillName.Anatomy, 65535.5 );
		SkillBonuses.SetValues( 2, SkillName.AnimalLore, 65535.5 );
		SkillBonuses.SetValues( 3, SkillName.ItemID, 65535.5 );
		SkillBonuses.SetValues( 4, SkillName.ArmsLore, 65535.5 );
		...
		public AdminEarrings ( Serial serial ) : base( serial )
		{
		}
