...
{
	public class AdminCollar : PlateGorget
	{
		...
		public AdminCollar()
		{
			...
			SkillBonuses.SetValues( 0, SkillName.Camping, 65535.5 );
			SkillBonuses.SetValues( 1, SkillName.Carpentry, 65535.5 );
			SkillBonuses.SetValues( 2, SkillName.Cartography, 65535.5 );
			SkillBonuses.SetValues( 3, SkillName.Cooking, 65535.5 );
			SkillBonuses.SetValues( 4, SkillName.DetectHidden, 65535.5 );
		...
		public AdminCollar( Serial serial ) : base( serial )
		{
		}
