...
namespace Server.Mobiles
{
	...
	public class ShadowKnightLeader : RegionInvasionLeader
	{
		...
		[Constructable]
		public ShadowKnightLeader() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public ShadowKnightLeader( Serial serial ) : base( serial )
		{
		}
