...
namespace Server.Mobiles
{
	...
	public class DarknightCreeperLeader : RegionInvasionLeader
	{
		public override bool IgnoreYoungProtection { get { return Core.ML; } }

		[Constructable]
		public DarknightCreeperLeader() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public DarknightCreeperLeader( Serial serial ) : base( serial )
		{
		}
