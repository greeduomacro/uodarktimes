...
{
    public class SemidarLeader : RegionInvasionLeader
	{
		//public override ChampionSkullType SkullType{ get{ return ChampionSkullType.Pain; } }

		[Constructable]
		public SemidarLeader() : base( AIType.AI_Mage, FightMode.Closest, 18, 1, 0.1, 0.2)
		{
			Name = "Semidar";
			Body = 174;
			BaseSoundID = 0x4B0;
		...
		public SemidarLeader( Serial serial ) : base( serial )
		{
		}
