...
namespace Server.Mobiles
{
	...
	public class DemonKnightLeader : RegionInvasionLeader
	{
		...
		[Constructable]
		public DemonKnightLeader() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public DemonKnightLeader( Serial serial ) : base( serial )
		{
		}
