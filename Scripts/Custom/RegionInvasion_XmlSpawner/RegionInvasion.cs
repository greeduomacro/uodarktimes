...
namespace Server.Mobiles
{
    ...
    {
        private static int range = 300; // This is the maximum range from the leader that the scritp checks for spawners.
        private double msgevery = 30.0; // How much time is "xxx is still under..." msgs(in minutes). 0 for disable.
