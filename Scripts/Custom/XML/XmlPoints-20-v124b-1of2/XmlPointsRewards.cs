...
namespace Server.Engines.XmlSpawner2
{
    public class XmlPointsRewards
    {
	    ...
	    PointsRewardList.Add( new XmlPointsRewards( 1000, typeof(PowerScroll), "105 Tailoring powerscroll", 1000, 0x14F0, new object[] { SkillName.Tailoring, 105 }));
	    PointsRewardList.Add( new XmlPointsRewards( 2000, typeof(PowerScroll), "110 Tailoring powerscroll", 1000, 0x14F0, new object[] { SkillName.Tailoring, 110 }));
	    PointsRewardList.Add( new XmlPointsRewards( 4000, typeof(PowerScroll), "115 Tailoring powerscroll", 1000, 0x14F0, new object[] { SkillName.Tailoring, 115 }));
            ...
            PointsRewardList.Add( new XmlPointsRewards( 100, typeof(LeatherGlovesOfMining), "+5 Leather Gloves Of Mining", 200, 0x13c6, new object[] { 5 }));
