...
namespace Server.Misc
{
	public class Email
	{
		...
		public static readonly string EmailServer = "anthrax101@seznam.cz";

		public static readonly string CrashAddresses = "anthrax101@seznam.cz";
		public static readonly string SpeechLogPageAddresses = "anthrax101@seznam.cz";
